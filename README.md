# AgHM
Trata-se da minha resolução do exercício do Jogo Nim, proposto no curso de Introdução à Ciência da Computação em Python - USP, do Coursera, conforme as instruções abaixo:
